...
const AllDeposit = () => {
  ...
  // const {isLoading, data, isError, refetchPaginated} = useGetAllDepositQuery({
  //   accesstoken,
  ...
  useEffect(() => {
    ...
    if (paginatedData?.deposits) {
      ...
      // Update `hasMore` based on the length of the new data
      setHasMore(paginatedData.deposits.length >= limit);
    }
    ...
    try {
      ...
      if (response.data?.deposits) {
        ...
        setPartners(prevPartners => {
          ...
          response.data.deposits.forEach(freshPartner => {
  ...
  //     refetchPaginated(); // Fetch next page data
...
//     {accesstoken, page, limit},
//     {
//       refetchPaginatedOnMountOrArgChange: true,
//       forceRefetch: true,
//     },
//   );
