import {
  ...
  const Createcountry = () => {
    ...
    const [countrycurrencyvaluecomparedtoinr, setcountrycurrencyvaluecomparedtoinr] = useState('');
    ...
    const submitDeposit = async () => {
      ...
      if (!imageSource) {
        ...
        try {
          ...
          formData.append('countrycurrencyvaluecomparedtoinr', countrycurrencyvaluecomparedtoinr);
