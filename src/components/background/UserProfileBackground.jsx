        ...
        <View
          ...
          <TouchableOpacity
            style={{
              borderRadius: 100,
              overflow: 'hidden',
              width:  Platform.OS === 'android' ? heightPercentageToDP(20) : heightPercentageToDP(15),
              height: Platform.OS === 'android' ? heightPercentageToDP(20) : heightPercentageToDP(15),
              zIndex: 2,
              position: 'absolute',
              top: heightPercentageToDP(-4),
              left: Platform.OS === 'android' ? heightPercentageToDP(4) : heightPercentageToDP(7),
            }}>
            {user?.avatar?.url ? (
              <Image
          ...
          <View
            style={{
              ...
              zIndex: 3,
              alignSelf: 'stretch',
              marginBottom: Platform.OS === 'android' ? heightPercentageToDP(2) : heightPercentageToDP(0)
            }}>
            {/** name */}
            <GradientText style={{...styles.textStyle,textAlign: "center"}} >
              {user ? user.name : ''}
            </GradientText>
            {/** email */}
