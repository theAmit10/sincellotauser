    ...
    <NavigationContainer>
      <Stack.Navigator
        ...
        <Stack.Group>
          ...
          />
          <Stack.Screen
            name="CreatePowerballTime"
            component={CreatePowerballTime}
          />

          <Stack.Screen
            name="CreatePowerballNotification"
            component={CreatePowerballNotification}
          />
          <Stack.Screen
