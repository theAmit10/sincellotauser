...
const ALL_RESULT_API = server + "result/searchresult"

export default { LOGIN_API, USER_PROFILE_API, LOGOUT_API, REGISTER_API, ALL_LOCATION_API, ALL_TIME_API, ALL_DATE_API, ALL_RESULT_API }